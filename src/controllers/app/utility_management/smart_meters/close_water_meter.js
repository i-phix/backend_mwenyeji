...
const closeMeter = async (request, reply) => {
  try {
    ...
    const meterServiceUrl = process.env.sandboxCloseMeterEndUrl;
    ...
    return reply.code(200).send({
      success: true,
      message: 'The meter will be closed shortly',
      data: response.data
    });
  } catch (error) {
    ...
    console.error('Error forwarding close meter request:', error);
